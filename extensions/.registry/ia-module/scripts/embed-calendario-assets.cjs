 ...
 * Eseguire dalla root del modulo: node scripts/embed-calendario-assets.cjs
 */
const fs = require('fs');
...
const content = `// Generato da scripts/embed-calendario-assets.cjs – non modificare a mano
